...
<html>
    ...
    <body>
        <div class="container">
            ...
            <%
                System.out.println("*************** listadoClientes.jsp HA EMPEZADO A EJECUTARSE ***************");

                System.out.println("listadoClientes.jsp: Intentando obtener 'datos' de la sesión.");

                String datos[][] = (String[][]) session.getAttribute("datos");
                
                if (datos == null || datos.length == 0) {
                    if (datos == null) {
                        System.out.println("listadoClientes.jsp: 'datos' es NULL en la sesión.");
                    } else if (datos.length == 0) {
                        System.out.println("listadoClientes.jsp: 'datos' es una matriz vacía (length = 0).");
                    }
                    out.print("<p class='no-clientes-message'>No hay clientes para mostrar o no se pudieron cargar los datos.</p>");
                } else {
                    System.out.println("listadoClientes.jsp: Se encontraron " + datos.length + " filas de clientes.");

                    out.print("<div class='table-container'>"); 
                    out.print("<table>");
                    out.print("<thead><tr>");
                    out.print("<th>Cédula</th>");
                    out.print("<th>Nombre</th>");
                    out.print("<th>Apellido</th>");
                    out.print("<th>Correo</th>");
                    out.print("<th>Teléfono</th>");
                    ...
                    for (String[] registro : datos) {
                        out.print("<tr>");
                        out.print("<td><a href=\"../control/ct_verCliente.jsp?cedulaCliente="+registro[0]+"\">" + registro[0] + "</a></td>");
                        out.print("<td>" + registro[1] + "</td>");
                        out.print("<td>" + registro[2] + "</td>");
                        out.print("<td>" + registro[3] + "</td>");
                        out.print("<td>" + registro[5] + "</td>");
                        out.print("<td>" + registro[6] + "</td>");
                        out.print("<td>" + (registro[7] != null && registro[7].equals("1") ? "Activo" : "Inactivo") + "</td>");
                        out.print("</tr>");
                    }
                    out.print("</tbody>");
                    out.print("</table>");
